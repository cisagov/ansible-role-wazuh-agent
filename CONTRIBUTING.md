...
issue](https://github.com/cisagov/ansible-role-wazuh-agent/issues) in
...
request](https://github.com/cisagov/ansible-role-wazuh-agent/pulls), you
...
```console
cd ansible-role-wazuh-agent
pyenv virtualenv <python_version_to_use> ansible-role-wazuh-agent
pyenv local ansible-role-wazuh-agent
